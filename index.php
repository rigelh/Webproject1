...
<head>
  <meta charset="utf-8" />
  <title>DRYME - Free Laundry Service Website</title>
...
<body>
        ...
        <div class="carousel-item active">
          ...
          <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
            <div class="p-3" style="max-width: 900px">
              ...
              <a href="#section2" class="btn btn-primary py-md-3 px-md-5 mt-2">Learn More</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 d-flex align-items-center justify-content-center bg-secondary mb-4 mb-lg-0" style="height: 100px">
          <div class="d-inline-flex">
            ...
            <div class="d-flex flex-column">
              ...
              <p class="m-0 text-white">rruga xxx, Tirana , Albania</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 d-flex align-items-center justify-content-center bg-secondary mb-4 mb-lg-0" style="height: 100px">
          <div class="d-inline-flex text-left">
            ...
            <div class="d-flex flex-column">
              ...
              <p class="m-0 text-white">+355 xxxxxxxxx</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- About Start -->
  <div class="container-fluid py-5" id="section2">
      ...
      <div class="owl-carousel testimonial-carousel">
        ...
        <div class="testimonial-item">
          <img class="position-relative rounded-circle bg-white shadow mx-auto" src="img/testimonial-4.jpg" style="
              ...
              " alt="" />
          <div class="bg-light text-center p-4 pt-0">
            <h5 class="font-weight-medium mt-5">Elisabeth</h5>
