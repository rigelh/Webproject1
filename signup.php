...
<body>
  ...
  <form class="container mt-5" novalidate="" method="POST" id="myForm">
    ...
    <div>
      <div>
        <button type="submit" class="btn btn-secondary mr-1" id="btnSubmit" onmouseover="mOver(this)" onmouseout="mOut(this)">Sign up</button>

      </div>
      <small>
        Have an account?<a href="login.php" target="_blank" class="submit-button">
          <b>Login here!</b></a></small>
    </div>
  </form>
